...
import ImportsSettingsScreen from './screens/ImportsSettingsScreen';
      ...
      <NavigationContainer>
        {user ? (
            ...
            screenOptions={({ route }) => ({
              drawerIcon: ({ color, size }) => {
                ...
                if (route.name === 'Dashboard') {
                  ...
                  iconName = 'wallet';
                } else if (route.name === 'Imports & Settings') { 
          ...
          >
            ...
            <Drawer.Screen name="Imports & Settings" component={ImportsSettingsScreen} /> 
